...
const Navbar = () => {
  ...
  useEffect(() => {
    fetchData('search-options').then(setOptions);
  }, []);
  ...
  return (
    <header className="top-0 z-40 sticky bg-white py-2">
      <nav className="flex lg:flex-row flex-col lg:justify-between justify-center items-center gap-5 m-auto px-10 py-2 w-full max-w-[800px] lg:max-w-[1300px]">
        <div className="flex lg:flex-row flex-col items-center gap-8 lg:gap-14">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-14 text-slate-600">
