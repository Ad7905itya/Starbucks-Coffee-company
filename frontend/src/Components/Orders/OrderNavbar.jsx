        ...
        <section className='bg-[#1e3932] py-2'>
            <div className='flex md:flex-row flex-col md:justify-between items-center md:items-start gap-10 md:gap-5 m-auto px-8 pt-5 pb-4 w-full max-w-[900px] lg:max-w-[1280px]'>
                ...
                <div className='flex justify-center md:justify-end rounded-xl w-full'>
                    <button onClick={onClick1} disabled={!first.text}>
                        <DineInBtn
                            ...
                            image={!IsActive.firstBtn ? first.image1 : first.image2}
                            title={first.text || 'Loading...'}
                        />
                    </button>
                    <button onClick={onClick2} disabled={!second.text}>
                        <DineInBtn
                            ...
                            image={!IsActive.SecondBtn ? second.image1 : second.image2}
                            title={second.text || 'Loading...'}
                        />
                    </button>
                </div>
            </div>
