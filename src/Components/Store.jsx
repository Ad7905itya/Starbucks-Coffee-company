...
const Store = () => {
    return (
        <main>
            ...
            <div className='m-auto px-10 py-2 max-w-[800px] lg:max-w-[1300px] text-slate-700 text-sm'>{'Home > Find A Store'}</div>

            <section className='flex m-auto max-w-[900px] lg:max-w-[1280px]'>
                <aside className='flex flex-col items-center gap-5 w-1/2 lg:w-[35%]'>
                    ...
                    <div className='flex flex-col items-center gap-2 mx-3 mb-4'>
                ...
                <aside className='flex justify-center items-start bg-[#f9f9f9] shadow-5xl p-3 w-1/2 lg:w-[65%] h-screen'>
                    <ErrorPopup
